...
//		w.test7();
	 ...
	 * 해당 단수의 구구단을 출력하세요.
	 * 계속할지 여부를 물어보고 반복실행 하세요. 
	 * 단 , 2~9 사이의 수가 아니라면 잘못 입력하셨습니다. 출력
	 */
	...
	public void test7() {
		...
		do {
			...
			if(dan >= 2 && dan <= 9) {
				...
				yn = sc.next().charAt(0); // 사용자가 y/n을 입력하게 하기위해서 charAt(0) 사용함
...
//		while(true) {
//			System.out.println("HI"); //이건 무한반복 계속 true 나옴
//			//반복문 중지 코드 = break 사용해야함
//		}
